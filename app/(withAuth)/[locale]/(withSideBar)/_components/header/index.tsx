...
const DashboardHeading = () => {
  ...
  return (
    <div className='bg-main-opposition border border-main-opposition flex justify-between p-6 mt-2 ml-4 mr-4 w-auto rounded-2xl '>
      <InputField className='w-[340px]  placeholder-secondary-grey-dark bg-bg-input-dashboard' icon={<SearchIcon width='18' height='24'/>} placeholder={t("SEARCHBAR")} type="text" />
